...
Этот проект - коммерческий сервис с платными подписками (FREE, BASIC, PRO, ELITE).

Разрешено:
- ✅ Форки и модификации для личного/образовательного использования
- ✅ Использование в собственных некоммерческих проектах
- ✅ Интеграция в отличающиеся продукты

Запрещено:
- ❌ Создание конкурирующих платных сервисов
- ❌ Предложение подписок на основе этого кода
- ❌ Монетизация без письменного разрешения
- ❌ Удаление/обход системы подписок

Официальный сервис: https://pattmsc.online

Подробности в файле [LICENSE](LICENSE) ([Русская версия](LICENSE.ru.md)).
