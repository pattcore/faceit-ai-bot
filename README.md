...
- 📢 Telegram-бот для уведомлений и быстрых запросов анализа (экспериментальный режим, подробнее в документации).
- 🎧 Discord-бот для демонстрации интеграции с серверами и уведомлениями.
